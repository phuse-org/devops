...
Keep more arbitrary seperate from recomended, e.g. have 'core/minimum' vs 'extended recomended' - e.g. linting is not a something that's usually a high priority. Relationship of going to CRAN against core? Common workflow would be to increase CICD as project / contributors grow [todo]
